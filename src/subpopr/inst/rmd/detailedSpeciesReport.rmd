...
speciesID <- "refGenome2clus"# "155864"
subpopOutDir <- "~/Dropbox/PostDocBork/subspecies/toolDevelopment/tutorial/v2_tutorial/results/params.hr10.hs80.ps80.gs80/output/"
metasnvOutDir <- "~/Dropbox/PostDocBork/subspecies/toolDevelopment/tutorial/v2_tutorial/output/"
distMethod <- "mann"
#bamSuffix <- ".fr11v2UL_subspec71.unique.sorted.bam"
doGenoPos <- T
psCut <- 0.8
source("../../R/getSpeciesTaxonomy.R")
source("../../R/utils.R")
TAXA.NCBI.MOTU.MAP <- readRDS("../../data/TAXA.NCBI.MOTU.MAP.Rds")
```
