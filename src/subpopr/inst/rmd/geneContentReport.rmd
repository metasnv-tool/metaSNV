...
```{r}
pathCorrP <- paste0(subpopOutDir,"/",speciesID,"_corrKegg-pearson.tsv")
pathCorrS <- paste0(subpopOutDir,"/",speciesID,"_corrKegg-spearman.tsv")
...
if(!"corrP" %in% ls()){
  print(paste0("Aborting due to error in loading file: ",corrP))
  knitr::knit_exit()
}
if(!"corrS" %in% ls()){
  print(paste0("Aborting due to error in loading file: ",corrS))
  knitr::knit_exit()
}
